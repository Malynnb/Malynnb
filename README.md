...
* Collected weather, airport infrastructure, and city-level demographic data from multiple sources
* Designed a relational database and automated data loading using SQLAlchemy
